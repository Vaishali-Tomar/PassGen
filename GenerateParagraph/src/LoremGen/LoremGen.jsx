...
function LoremGenerator() {
  ...
  return (
    <div>
      <h1 className='text-3xl text-red-600 mb-4'>TIRED OF BORING LOREM IPSUM?
</h1>
      ...
      <button className="text-2xl text-orange-800 border-spacing-0 bg-orange-400 rounded-md mr-20"onClick={generateLorem}>Generate</button>
      {generatedText && (
        <div>
